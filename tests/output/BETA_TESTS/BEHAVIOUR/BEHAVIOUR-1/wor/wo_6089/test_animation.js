...
lib.ssMetadata = [
		{name:"test_animation_atlas_", frames: [[802,0,800,800],[0,0,800,800],[1669,1126,225,80],[1179,802,488,641],[1179,1445,658,234],[0,802,662,875],[1669,1020,190,104],[1669,454,310,384],[1604,0,438,452],[664,802,513,859],[1669,840,322,178]]}
];
...
(lib.teacher = function(mode,startPosition,loop) {
	...
	// Layer_8
	this.instance_8 = new lib.CachedTexturedBitmap_33();
...
(lib.linkageName_White = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.linkageName_Content = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Content
	this.instance = new lib.teacher("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(189.3,942.35,1.4282,1.4282,0,0,0,-160,1.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:190.3,y:592.4},23,cjs.Ease.quadOut).to({x:189.3,y:942.35},23).wait(1));

}).prototype = p = new cjs.MovieClip();


(lib.linkageName = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"1":0,"2":23});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(23).call(this.frame_23).wait(23).call(this.frame_46).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.Outline).wait(47));
	...
	// Content_obj_
	this.Content = new lib.linkageName_Content();
	this.Content.name = "Content";
	this.Content.parent = this;
	this.Content.setTransform(187.2,943.1,1,1,0,0,0,187.2,943.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.Content).wait(47));

	// White_obj_
	this.White = new lib.linkageName_White();
	...
	this.timeline.addTween(cjs.Tween.get(this.White).wait(47));
...
// stage content:
(lib.PREFERENCES1 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		console.log("preferences animation version: 2");
		
		document.addEventListener("click", function () {
			
			console.log("Click on animation");
